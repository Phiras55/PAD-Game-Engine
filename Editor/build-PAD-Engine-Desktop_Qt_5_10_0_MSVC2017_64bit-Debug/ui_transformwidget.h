...
""));
        ...
        Rot_X->setSizeConstraint(QLayout::SetFixedSize);
        ...
        Rot_Y->setSizeConstraint(QLayout::SetFixedSize);
        ...
        sizePolicy2.setHeightForWidth(val_Rot_Y->sizePolicy().hasHeightForWidth());
        val_Rot_Y->setSizePolicy(sizePolicy2);
        ...
        Rot_Z->setSizeConstraint(QLayout::SetFixedSize);
        ...
        sizePolicy2.setHeightForWidth(val_Rot_Z->sizePolicy().hasHeightForWidth());
        val_Rot_Z->setSizePolicy(sizePolicy2);
        ...
        Scale_X->setSizeConstraint(QLayout::SetFixedSize);
        ...
        sizePolicy2.setHeightForWidth(val_Scale_X->sizePolicy().hasHeightForWidth());
        val_Scale_X->setSizePolicy(sizePolicy2);
        ...
        Scale_Y->setSizeConstraint(QLayout::SetFixedSize);
        ...
        sizePolicy2.setHeightForWidth(val_Scale_Y->sizePolicy().hasHeightForWidth());
        val_Scale_Y->setSizePolicy(sizePolicy2);
        ...
        Scale_Z->setSizeConstraint(QLayout::SetFixedSize);
